   ...
   return (
      <ul className="pagination pagination-sm m-0 float-end">
         <li className="page-item">
            <button className="page-link" onClick={() => navigateToPage(1)} disabled={currentPage === 1}>&laquo;&laquo;</button>
         </li>
         <li className="page-item">
            <button className="page-link" onClick={() => navigateToPage(currentPage - 1)} disabled={currentPage === 1}>&laquo;</button>
         </li>
         ...
         <li className="page-item">
            <button className="page-link" onClick={() => navigateToPage(currentPage + 1)} disabled={currentPage === pageCount}>&raquo;</button>
         </li>
         <li className="page-item">
            <button className="page-link" onClick={() => navigateToPage(pageCount)} disabled={currentPage === pageCount}>&raquo;&raquo;</button>
         </li>
      </ul>
   );
};
